...
- **2025-01-05**: Zigbee2MQTT 2.0 compatibility without 'Home Assistant legacy action sensors' turned on, version update, Fix regex for updated helper JSON serialization starting from Home Assistant 2023.5.0, added Zigbee2MQTT device page reference.([@moralmunky](https://github.com/moralmunky))
