...
- **2025-01-05**: BREAKING CHANGE: Zigbee2MQTT 2.0 compatibility without 'Home Assistant legacy action sensors' turned on, version update, fix regex for updated helper JSON serialization starting from Home Assistant 2023.5.0, added Zigbee2MQTT device page reference, modern syntax. ([@moralmunky](https://github.com/moralmunky))